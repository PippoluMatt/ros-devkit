...
def _print_help() -> None:
    ...
    print("  gazebo-simulation       Diagnose, set up, and add plugins to Gazebo simulation wiring")
    print("  ros2-control-pluginize  Check or add ros2_control pluginlib wiring")
    ...
    print("  Diagnose, set up, or add plugins to Gazebo simulation wiring for ROS 2 packages.")
    print()
    print("  Modes (mutually exclusive, one required):")
    ...
    print("    --add-plugin  Add a Gazebo system plugin to the robot xacro and/or world SDF")
    print()
    print("  Options:")
    ...
    print("    --plugin NAME              Plugin alias to add (use with --add-plugin)")
    print("    --list-plugins             List available Gazebo Sim plugin aliases")
    print()
    print("  Examples:")
    ...
    print("    ros-devkit gazebo-simulation --add-plugin --plugin diff_drive")
    print("    ros-devkit gazebo-simulation --add-plugin --plugin imu")
    print("    ros-devkit gazebo-simulation --add-plugin --plugin lidar --robot-name my_robot")
    print("    ros-devkit gazebo-simulation --add-plugin --list-plugins")
    print()
    print("ros2-control-pluginize")
    print("  Check or add static pluginlib wiring for existing ros2_control packages.")
    print()
    print("  Modes (mutually exclusive, one required):")
    print("    --check PACKAGE_DIR      Check one *_hardware or *_controllers package")
    print("    --pluginize PACKAGE_DIR  Add missing pluginlib wiring, then run --check")
    print()
    print("  Examples:")
    print("    ros-devkit ros2-control-pluginize --check my_robot_hardware")
    print("    ros-devkit ros2-control-pluginize --pluginize my_robot_hardware")
    print("    ros-devkit ros2-control-pluginize --check my_robot_controllers")
    print()
    print("doctor")
